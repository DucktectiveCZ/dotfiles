...
DISABLE_AUTO_TITLE=true
ZSH_THEME_TERM_TITLE_IDLE="Termiquak :3"
...
plugins=(git alias-finder archlinux arduino-cli bazel colorize command-not-found copyfile emoji gitfast gitignore golang npm rust postgres pip zoxide zsh-autosuggestions)
